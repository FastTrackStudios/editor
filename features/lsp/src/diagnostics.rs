...
/// line/character form.
///
/// The client surfaces this (rather than
...
impl Severity {
    const fn from_lsp(sev: Option<lsp_types::DiagnosticSeverity>) -> Self {
        match sev {
...
/// by URI, with version-based staleness filtering.
///
/// The host owns one
